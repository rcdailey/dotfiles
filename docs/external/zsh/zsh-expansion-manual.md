...
:   The value, if any, of the parameter name is substituted.
    ...
    If name is an array parameter, and the KSH\_ARRAYS option is not
...
:   Quote with backslashes only characters that are special to pattern
    ...
    Quoting using one of the q family of flags does not work
...
separately. Thus, (#a1)README~READ\_ME matches
READ.ME but not READ\_ME, as the trailing READ\_ME is matched
without approximation. However,
(#a1)README~(#a1)READ\_ME
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Expansion "Beginning of this chapter or previous chapter") ] | [ [<](#Approximate-Matching "Previous section in reading order") ] | [ [Up](#Filename-Generation "Up section") ] | [ [>](#Glob-Qualifiers "Next section in reading order") ] | [ [>>](Parameters.html#Parameters "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
Even shorter forms are available when the option GLOB\_STAR\_SHORT is
set. In that case if no / immediately follows a \*\* or \*\*\*
they are treated as if both a / plus a further \* are present.
Hence:
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Expansion "Beginning of this chapter or previous chapter") ] | [ [<](#Recursive-Globbing "Previous section in reading order") ] | [ [Up](#Filename-Generation "Up section") ] | [ [>](Parameters.html#Parameters "Next section in reading order") ] | [ [>>](Parameters.html#Parameters "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
If the option BARE\_GLOB\_QUAL is set, then a trailing set of parentheses
...
If the option EXTENDED\_GLOB is set, a different syntax for glob
qualifiers is available, namely ‘(#qx)’
...
:   The string will be executed as shell code. The filename will be
    ...
    is appended to the array zsh\_eval\_context the duration of
    execution.
...
:   appends a trailing qualifier mark to the filenames, analogous to the
    LIST\_TYPES option, for the current pattern (overrides M)
...
:   specifies how the names of the files should be sorted. The following values
    of c sort in the following ways:
    ...
    Note that the modifiers ^ and - are used,
    ...
    globsort appended to zsh\_eval\_context. The code
...
parenthesis is interpreted as a modifier (see [Modifiers](#Modifiers)
in [History Expansion](#History-Expansion)). Each modifier must be introduced by a
...
(but not those starting with a dot, since GLOB\_DOTS is explicitly
...
modifiers in order from left to right. So if EXTENDED\_GLOB is set and
...
|  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Expansion "Beginning of this chapter or previous chapter") ] | [ [>>](Parameters.html#Parameters "Next chapter") ] |  |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
