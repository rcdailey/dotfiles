...
then *widget-name* can be used in `bindkey`, or
...
then `$LBUFFER` contains the line left of the cursor stripped of all
...
We test `$__searching` instead of `$WIDGET` directly to be able to
