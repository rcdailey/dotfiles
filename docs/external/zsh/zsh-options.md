|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](Parameters.html#Parameters "Beginning of this chapter or previous chapter") ] | [ [<](Parameters.html#Parameters-Used-By-The-Shell "Previous section in reading order") ] | [ [Up](index.html#Top "Up section") ] | [ [>](#Specifying-Options "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |

# 16 Options

|  |  |  |
| --- | --- | --- |
| [16.1 Specifying Options](#Specifying-Options) |  |  |
| [16.2 Description of Options](#Description-of-Options) |  |  |
| [16.3 Option Aliases](#Option-Aliases) |  |  |
| [16.4 Single Letter Options](#Single-Letter-Options) |  |  |

---

|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#Options "Previous section in reading order") ] | [ [Up](#Options "Up section") ] | [ [>](#Description-of-Options "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
For example, ‘allexport’ is equivalent to ‘A\_\_lleXP\_ort’.

The sense of an option name may be inverted by preceding it with
‘no’, so ‘setopt No\_Beep’ is equivalent to ‘unsetopt beep’.
...
SH\_OPTION\_LETTERS option is set).
...
description of the option LOCAL\_OPTIONS below.

---

|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#Specifying-Options "Previous section in reading order") ] | [ [Up](#Options "Up section") ] | [ [>](#Changing-Directories "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
‘unsetopt’, ‘set -o’ or ‘set +o’), those turned on by default
appear in the list prefixed with ‘no’. Hence (unless
KSH\_OPTION\_PRINT is set), ‘setopt’ shows all options whose settings
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#Description-of-Options "Previous section in reading order") ] | [ [Up](#Description-of-Options "Up section") ] | [ [>](#Completion-4 "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
:   If a command is issued that can’t be executed as a normal command,
    ...
    This option is only applicable if the option SHIN\_STDIN is set,
...
:   Never print the working directory after a cd (whether explicit or
    ...
    PUSHD\_SILENT. This option overrides the printing-related effects of
    POSIX\_CD.
...
:   When changing to a directory containing a path segment ‘..’ which would
    ...
    This option is overridden by CHASE\_LINKS.
...
:   Resolve symbolic links to their true values when changing directory.
    This also has the effect of CHASE\_DOTS, i.e. a ‘..’ path segment
...
:   Modifies the behaviour of cd, chdir and pushd commands
    ...
    builtin in
    [Shell Builtin Commands](Shell-Builtin-Commands.html#Shell-Builtin-Commands).
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#Changing-Directories "Previous section in reading order") ] | [ [Up](#Description-of-Options "Up section") ] | [ [>](#Expansion-and-Globbing "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
:   Automatically use menu completion after the second consecutive request for
    ...
    is overridden by MENU\_COMPLETE.
...
:   On an ambiguous completion, automatically list choices when the
    ...
    precedence over AUTO\_LIST. The setting of LIST\_AMBIGUOUS is
    respected. If AUTO\_MENU is set, the menu behaviour will then start
    with the third press. Note that this will not work with
    MENU\_COMPLETE, since repeated completion calls immediately cycle
...
:   When the current word has a glob pattern, do not insert all the words
    ...
    cycle through them like MENU\_COMPLETE. The matches are generated as if
    a ‘\*’ was added to the end of the word, or inserted at the cursor when
    COMPLETE\_IN\_WORD is set. This actually uses pattern matching, not
    ...
    on the GLOB\_COMPLETE option does not have this effect.
...
:   This option works when AUTO\_LIST or BASH\_AUTO\_LIST is also
    ...
    inserted. In the case of BASH\_AUTO\_LIST, this means that the list
...
:   On an ambiguous completion, instead of listing possibilities or beeping,
    ...
    in the other direction. This option overrides AUTO\_MENU.
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#Completion-4 "Previous section in reading order") ] | [ [Up](#Description-of-Options "Up section") ] | [ [>](#History "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
:   In a glob pattern, treat a trailing set of parentheses as a qualifier
    ...
    characters. See [Filename Generation](Expansion.html#Filename-Generation).
...
:   Expand expressions in braces which would not otherwise undergo brace
    ...
    [Brace Expansion](Expansion.html#Brace-Expansion).
...
:   Make globbing (filename generation) sensitive to case. Note that other
    ...
    (unless the option BARE\_GLOB\_QUAL is unset).
...
CASE\_PATHS
:   If CASE\_PATHS is not set (the default), CASE\_GLOB affects the
...
:   Perform = filename expansion.
    (See [Filename Expansion](Expansion.html#Filename-Expansion).)
...
:   Substitutions using the :s and :& history modifiers are performed
    ...
    See
    [Modifiers](Expansion.html#Modifiers).

IGNORE\_BRACES (-I) <S>
:   Do not perform brace expansion. For historical reasons this
    also includes the effect of the IGNORE\_CLOSE\_BRACES option.

IGNORE\_CLOSE\_BRACES
:   When neither this option nor IGNORE\_BRACES is set, a sole
    ...
    IGNORE\_BRACES, this option does not disable brace expansion.
...
:   All unquoted arguments of the form ‘anything=expression’
    ...
    This option respects the setting of the KSH\_TYPESET option. In other
...
:   Disables the special meaning of ‘(’, ‘|’, ‘)’
    ...
    the shell accepts patterns. If SH\_GLOB is set but KSH\_GLOB is
...
:   Print a warning message when an existing parameter from an
    ...
    to WARN\_CREATE\_GLOBAL as in this case the warning is only
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#Expansion-and-Globbing "Previous section in reading order") ] | [ [Up](#Description-of-Options "Up section") ] | [ [>](#Initialisation "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
:   If this is set, zsh sessions will append their history list to
    ...
    $SAVEHIST (see also the HIST\_SAVE\_BY\_COPY option).
...
:   If the internal history needs to be trimmed to add the current command line,
    ...
    HIST\_IGNORE\_ALL\_DUPS once the history fills up with unique events.
...
:   This option is a variant of INC\_APPEND\_HISTORY in which, where
    ...
    correctly in the history file in EXTENDED\_HISTORY format. This
    ...
    SHARE\_HISTORY are turned off. The three options should be
...
:   This option both imports new commands from the history file, and also
    ...
    with timestamps ala EXTENDED\_HISTORY (which makes it easier to find
    ...
    get imported, you may wish to turn SHARE\_HISTORY off,
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#History "Previous section in reading order") ] | [ [Up](#Description-of-Options "Up section") ] | [ [>](#Input_002fOutput "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
:   After /etc/zshenv is sourced on startup, source the
    ...
    files, as described in [Files](Files.html#Files).
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#Initialisation "Previous section in reading order") ] | [ [Up](#Description-of-Options "Up section") ] | [ [>](#Job-Control "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
:   Allows ‘>’ redirection to truncate existing files.
    ...
    If the option is not set, and the option APPEND\_CREATE is also
    not set, ‘>>!’ or ‘>>|’ must be used to create a file.
    If either option is set, ‘>>’ may be used.

CLOBBER\_EMPTY
:   This option is only used if the option CLOBBER is not set: note that
...
:   Try to correct the spelling of commands.
    Note that, when the HASH\_LIST\_ALL option is not set or when some
    directories in the path are not readable, this may falsely report spelling
    errors the first time some commands are used.

    The shell variable CORRECT\_IGNORE may be set to a pattern to
    match words that will never be offered as corrections.

CORRECT\_ALL (-O)
:   Try to correct the spelling of all arguments in a line.

    The shell variable CORRECT\_IGNORE\_FILE may be set to a pattern to
...
:   Use the Dvorak keyboard instead of the standard qwerty keyboard as a basis
    for examining spelling mistakes for the CORRECT and CORRECT\_ALL
...
:   Whenever a command name is hashed, hash the directory containing it,
    ...
    Has no effect if neither HASH\_CMDS nor CORRECT is set.

HASH\_EXECUTABLES\_ONLY
:   When hashing commands because of HASH\_CMDS, check that the
...
SHORT\_REPEAT
:   Allow the short form repeat as SHORT\_LOOPS but without enabling
...
:   If a line ends with a backquote, and there are an odd number
    ...
    As an alternative the variable KEYBOARD\_HACK lets you choose the
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#Input_002fOutput "Previous section in reading order") ] | [ [Up](#Description-of-Options "Up section") ] | [ [>](#Prompting "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
:   Report the status of background and suspended jobs before exiting a shell
    ...
    NO\_CHECK\_JOBS is best used only in combination with NO\_HUP, else
    ...
    the section ‘Special Functions’ in [Functions](Functions.html#Functions)
    is not counted for this purpose.

CHECK\_RUNNING\_JOBS <Z>
:   Check for both running and suspended jobs when CHECK\_JOBS is enabled.
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#Job-Control "Previous section in reading order") ] | [ [Up](#Description-of-Options "Up section") ] | [ [>](#Scripts-and-Functions "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
:   Attempt to preserve a partial line (i.e. a line that did not end with a
    ...
    a ‘#’ for root. If set, the shell parameter PROMPT\_EOL\_MARK can be
    used to customize how the end of partial lines are shown.

    NOTE: if the PROMPT\_CR option is not set, enabling this option will
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#Prompting "Previous section in reading order") ] | [ [Up](#Description-of-Options "Up section") ] | [ [>](#Shell-Emulation "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |

### 16.2.9 Scripts and Functions

ALIAS\_FUNC\_DEF <S>
:   By default, zsh does not allow the definition of functions using
    the ‘name ()’ syntax if name was expanded as an
...
:   Output hexadecimal numbers in the standard C format, for example ‘0xFF’
    instead of the usual ‘16#FF’. If the option OCTAL\_ZEROES is also
    ...
    irrespective of the setting of C\_BASES.

C\_PRECEDENCES
:   This alters the precedence of arithmetic operators to be more
    like C and other programming languages;
    [Arithmetic Evaluation](Arithmetic-Evaluation.html#Arithmetic-Evaluation)
...
:   If a command has a non-zero exit status, execute the ZERR
    ...
    the trap. If the option DEBUG\_BEFORE\_CMD is set,
    as it is by default, and the option ERR\_EXIT is found to have been set
    ...
    Exiting due to ERR\_EXIT has certain interactions with asynchronous
    jobs noted in
    [Jobs & Signals](Jobs-_0026-Signals.html#Jobs-_0026-Signals).
...
:   If a command has a non-zero exit status, return immediately from the
    ...
    Normally this option inherits the behaviour of ERR\_EXIT that
    ...
    from summit (assuming the option remains set within summit), but
    not from the enclosing context. This behaviour is different from
    ERR\_EXIT which is unaffected by function scope.
...
:   If set, line numbers of expressions evaluated using the builtin eval
    ...
    EVAL\_LINENO is unset, the line number of the surrounding script or
...
:   If this option is set at the point of return from a shell function,
    ...
    and the LOCAL\_LOOPS, XTRACE and PRINT\_EXIT\_VALUE options are
...
:   If this option is set at the point of return from a shell function,
    ...
    of LOCAL\_OPTIONS on options; hence ‘emulate -L sh’ (or
...
:   If this option is set when a signal trap is set inside a function, then the
    ...
    trap behaviour in a function; unlike LOCAL\_OPTIONS, the value on exit
...
:   Perform implicit tees or cats when multiple
    redirections are attempted (see [Redirection](Redirection.html#Redirection)).
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#Scripts-and-Functions "Previous section in reading order") ] | [ [Up](#Description-of-Options "Up section") ] | [ [>](#Shell-State "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
:   When set, matches performed with the =~ operator will set the
    BASH\_REMATCH array variable, instead of the default MATCH and
    match variables. The first element of the BASH\_REMATCH array
    will contain the entire matched text and subsequent elements will contain
    extracted substrings. This option makes more sense when KSH\_ARRAYS is
...
:   If a fatal error is encountered (see
    [Errors](Shell-Grammar.html#Errors)), and the code is running
...
:   Do not use the values of NULLCMD and READNULLCMD
    ...
    such redirections fail (see [Redirection](Redirection.html#Redirection)).
...
:   Treat use of a subscript of value zero in array or string expressions as a
    ...
    If neither this option nor KSH\_ARRAYS is set, accesses to an element of
    ...
    includes zero will succeed. For example, if KSH\_ZERO\_SUBSCRIPT is not
    set,
...
:   This option may be used to temporarily disable FUNCTION\_ARGZERO and
    ...
    previous versions of the shell, emulations use NO\_FUNCTION\_ARGZERO
    instead of POSIX\_ARGZERO, which may result in unexpected scoping of
    $0 if the emulation mode is changed inside a function or script.
    To avoid this, explicitly enable POSIX\_ARGZERO in the emulate
    command:
    ...
    Note that NO\_POSIX\_ARGZERO has no effect unless FUNCTION\_ARGZERO
...
:   When this option is set the command builtin can be used to execute
    ...
    [[ -o non\_existent\_option ]] are suppressed.
...
:   When this option is set, only the ASCII characters a to z, A to
    ...
    When it is unset, zsh allows expressions of the form $#name
    to refer to the length of $name, even for special variables,
    ...
    ))’. without POSIX\_IDENTIFIERS set t has integer type, while with
...
:   When this option is set, the usual zsh behaviour of executing
    ...
    trap for exiting the shell; the LOCAL\_TRAPS option is
...
SH\_NULLCMD <K> <S>
:   Do not use the values of NULLCMD and READNULLCMD
    when doing redirections, use ‘:’ instead (see [Redirection](Redirection.html#Redirection)).
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#Shell-Emulation "Previous section in reading order") ] | [ [Up](#Description-of-Options "Up section") ] | [ [>](#Zle "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
:   This is an interactive shell. This option is set upon initialisation if
    ...
    (See the discussion of SHIN\_STDIN.)
...
:   Turn on privileged mode. Typically this is used when script is to be run
    ...
    /etc/suid\_profile is sourced (after /etc/profile on interactive
    ...
    function always changes it globally regardless of the LOCAL\_OPTIONS
    option.

RESTRICTED (-r)
:   Enables restricted mode. This option cannot be changed using
    unsetopt, and setting it inside a function always changes it
    globally regardless of the LOCAL\_OPTIONS option. See
    [Restricted Shell](Invocation.html#Restricted-Shell).

SHIN\_STDIN (-s, ksh: -s)
:   Commands are being read from the standard input.
    Commands are read from standard input if no command is specified with
    -c and no file of commands is specified. If SHIN\_STDIN
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#Shell-State "Previous section in reading order") ] | [ [Up](#Description-of-Options "Up section") ] | [ [>](#Option-Aliases "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#Zle "Previous section in reading order") ] | [ [Up](#Options "Up section") ] | [ [>](#Single-Letter-Options "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#Option-Aliases "Previous section in reading order") ] | [ [Up](#Options "Up section") ] | [ [>](#Default-set "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#Single-Letter-Options "Previous section in reading order") ] | [ [Up](#Single-Letter-Options "Up section") ] | [ [>](#sh_002fksh-emulation-set "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#Default-set "Previous section in reading order") ] | [ [Up](#Single-Letter-Options "Up section") ] | [ [>](#Also-note "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [<](#sh_002fksh-emulation-set "Previous section in reading order") ] | [ [Up](#Single-Letter-Options "Up section") ] | [ [>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next section in reading order") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
...
|  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [ [<<](#Options "Beginning of this chapter or previous chapter") ] | [ [>>](Shell-Builtin-Commands.html#Shell-Builtin-Commands "Next chapter") ] |  |  |  |  |  | [[Top](index.html#Top "Cover (top) of document")] | [[Contents](zsh_toc.html#SEC_Contents "Table of contents")] | [[Index](Concept-Index.html#Concept-Index "Index")] | [ [?](zsh_abt.html#SEC_About "About (help)") ] |
