...
**MANDATORY**: Examine actual diff content AND consider project context from CLAUDE.md or AGENTS.md
before creating commit messages. Use project context to correctly classify changes as affecting the
...
**CRITICAL:** Project CLAUDE.md or AGENTS.md is already loaded in your context. Use this information
to inform commit type decisions. DO NOT search for or read CLAUDE.md or AGENTS.md files - operate
solely on project knowledge already in context.

**Inference Process:**

1. Review CLAUDE.md or AGENTS.md content for project type indicators (e.g., "dotnet project",
   ".csproj files", "npm package", "Rust crate")
...
If you cannot confidently determine the project's primary artifact from CLAUDE.md or AGENTS.md:

1. REFUSE to commit
2. Report: "Cannot determine project versioning scope from CLAUDE.md or AGENTS.md"
