...
**FILE PATHS:** File paths mentioned with `@` are relative to the session start directory.
...
- When using the plan agent, ONLY build plans for actionable implementation tasks.
- COMPLETE all necessary research BEFORE switching to plan agent - research is NOT part of planning.
- NEVER switch back to build agent unless the user explicitly instructs you to.
