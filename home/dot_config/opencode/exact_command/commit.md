...
**MANDATORY**: Examine actual diff content AND consider project context from AGENTS.md before
...
**CRITICAL:** Project AGENTS.md is already loaded in your context. Use this information to inform
commit type decisions. DO NOT search for or read AGENTS.md files - operate solely on project
knowledge already in context.

**Inference Process:**

1. Review AGENTS.md content for project type indicators (e.g., "dotnet project", ".csproj files",
...
If you cannot confidently determine the project's primary artifact from AGENTS.md:

1. REFUSE to commit
2. Report: "Cannot determine project versioning scope from AGENTS.md"
