---
description: Add file path-based conventional commit rules to AGENTS.md
---

# Setup Conventional Commits Command

Add path-based conventional commit classification rules to a project's AGENTS.md file for consistent
...
```bash
[ -f AGENTS.md ] && echo "exists" || echo "missing"
```
...
### 4. Analyze Existing AGENTS.md Content

Read entire AGENTS.md and assess existing conventional commit guidance:
...
- Report: "AGENTS.md already has comprehensive conventional commit rules. No changes needed."
...
### 8. Insert or Consolidate Rules in AGENTS.md
...
```txt
AGENTS.md already has comprehensive conventional commit rules. No changes needed.
```
...
```txt
Added conventional commit rules to AGENTS.md at line X.
...
- If AGENTS.md missing: "AGENTS.md not found. Create it first with project context."
